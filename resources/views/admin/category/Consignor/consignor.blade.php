    ...
    <div class="container-fluid">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Add New Consignor</h3>
            </div>
            @if ($errors->any())
            ...
            @endif
            <form method="POST" action="{{ route('consignor.store') }}">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="consignor_name" name="consignor_name" value="{{ old('consignor_name') }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="consignor_code">Consignor Code *</label>
                                <input type="text" class="form-control" id="consignor_code" name="consignor_code" value="{{ old('consignor_code') }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
