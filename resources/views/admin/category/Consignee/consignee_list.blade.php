        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ url('/dash/consignee/create') }}" class="btn btn-success btn-sm">Add New</a>
                </div>
            </div>
            @if (session('success'))
            ...
            @endif
            <div class="card-body">
                <form method="GET" action="{{ url('/dash/consignee') }}" class="mb-3">
                    <div class="row">
                        <div class="col-md-4">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/dash/consignee/'.$consignee->id.'/edit') }}" class="btn btn-info btn-sm">Edit</a>
                                <a href="{{ url('/dash/consignee/'.$consignee->id) }}" class="btn btn-secondary btn-sm">View</a>
                                <form method="POST" action="{{ url('/dash/consignee/'.$consignee->id) }}" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
